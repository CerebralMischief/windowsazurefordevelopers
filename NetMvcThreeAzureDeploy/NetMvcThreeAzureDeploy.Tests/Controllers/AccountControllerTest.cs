...
using NetMvcThreeAzureDeploy;
using NetMvcThreeAzureDeploy.Controllers;
using NetMvcThreeAzureDeploy.Models;

namespace NetMvcThreeAzureDeploy.Tests.Controllers
{
